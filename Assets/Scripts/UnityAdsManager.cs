...
{
    public string GAME_ID = "5578052"; //replace with your gameID from dashboard. note: will be different for each platform.

    private const string BANNER_PLACEMENT = "Test_Banner_Android";
    private const string VIDEO_PLACEMENT = "Test_Interstitial_Android";
    private const string REWARDED_VIDEO_PLACEMENT = "Test_Rewarded_Android";
    ...
    {
        gameManager.showingRewarded = true;
    ...
    public void OnUnityAdsShowComplete(string placementId, UnityAdsShowCompletionState showCompletionState)
    {
        ...
        {
            if(gameManager.showingRewarded)
            {
                gameManager.AddSeeds(6);
            }
        }
